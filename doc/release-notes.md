Folm Core version 0.16.1 is now available from:

  <https://folmcore.org/bin/folm-core-0.16.1/>
...
- #12843 `df38b13` Test starting folmd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure folmd processes are cleaned up when tests end (sdaftuar)
