Folm Core version 0.13.2 is now available from:

  <https://folm.org/bin/folm-core-0.13.2/>
...
- #8908 `4a974b2` Update folm-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow folm-tx to create v2 transactions (flmdrak)
