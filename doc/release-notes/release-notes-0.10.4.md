Folm Core version 0.10.4 is now available from:

  <https://folm.org/bin/folm-core-0.10.4/>
...
- #6953 `43c2789` Split folm-tx into its own package
- #6953 `dfe0d4d` Include folm-tx binary on Debian/Ubuntu
