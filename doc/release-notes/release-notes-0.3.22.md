Download URL: https://sourceforge.net/projects/folm/files/Folm/folm-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 FLM fee schedule (users still pay 0.01 FLM per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #folm00 - #folm99
