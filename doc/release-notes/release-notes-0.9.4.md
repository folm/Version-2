Folm Core version 0.9.4 is now available from:

  https://folm.org/bin/0.9.4/
...
this update is incompatible with the Folm system and could lead to consensus
forks.

Folm Core released binaries from https://folm.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~folm/+archive/ubuntu/folm
- A third-party or self-compiled Folm Core

upgrade to Folm Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
