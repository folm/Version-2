Folm Core version 0.9.2.1 is now available from:

  https://folm.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 FLM to 0.01 FLM
...
- Fix "Start folm on system login"
