Folm version 0.5.4 is now available for download at:
http://sourceforge.net/projects/folm/files/Folm/folm-0.5.4/
...
http://gitorious.org/folm/folmd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Folm-Qt notifications under Growl 1.3.
Increase required age of Folm-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxFolm properly when installing Folm-Qt over it. (Windows)
