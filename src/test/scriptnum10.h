...
#ifndef FOLM_TEST_SCRIPTNUM10_H
#define FOLM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Folm Core 0.10.0, for cross-comparison.
 */
public:
