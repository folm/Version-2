...
#ifndef FOLM_QT_FOLMUNITS_H
#define FOLM_QT_FOLMUNITS_H
...
*/
class FolmUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FolmUnits(QObject *parent);

    /** Folm units.
      @note Source: https://en.folm.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        FLM,
...
typedef FolmUnits::Unit FolmUnit;

#endif // FOLM_QT_FOLMUNITS_H
