...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<FolmAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_folm-qt -platform xcb      # Linux
//     src/qt/test/test_folm-qt -platform windows  # Windows
//     src/qt/test/test_folm-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = FolmUnits::formatWithUnit(unit, balance, false, FolmUnits::separatorAlways);
    ...
    // Amount input
    FolmAmountField* amountInput = receiveCoinsDialog.findChild<FolmAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: folm:")) != -1);
