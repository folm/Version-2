...
By default, folmd will dump mempool on shutdown and
...
class MempoolPersistTest(FolmTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give folmd a second to reload the mempool
        ...
        self.log.debug("Prevent folmd from writing mempool.dat to disk. Verify that `savemempool` fails")
