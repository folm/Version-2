...
# TestNode: A peer we use to send messages to folmd, and store responses.
...
class CompactBlocksTest(FolmTestFramework):
    ...
    # This test actually causes folmd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that folmd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for folmd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # folmd will not send blocktxn responses for blocks whose height is
